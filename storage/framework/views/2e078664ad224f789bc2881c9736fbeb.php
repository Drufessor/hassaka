...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Project History')); ?> - <?php echo e($project->project_name); ?>
                    ...
                    <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                        ...
                        <dl class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($project->project_name); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Location</dt>
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($project->location); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Date</dt>
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($project->date->format('Y-m-d')); ?></dd>
                            </div>
                        </dl>
                    </div>
...
<?php endif; ?> <?php /**PATH C:\Users\Bintang Syaputra\Herd\hassaka\resources\views/audit-logs/project-history.blade.php ENDPATH**/ ?>